                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">{{ isset($video) ? 'Edit' : 'Add' }} Video</a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        @endif
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="title" type="text" name="title" class="form-control" placeholder="Enter Title" value="{{ $video->title ?? old('title') ?? '' }}">
                                                    @error('title')
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="category_id" class="form-control">
                                                        ...
                                                        @foreach($categories as $key => $category)
                                                            <option value="{{ $category->id ?? '' }}" {{ isset($video) && ($video->category_id == $category->id || old('category_id') == $category->id ) ? 'selected' : '' }}>{{ $category->title ?? '' }}</option>
                                                        @endforeach
                                            ...
                                            <!-- for arabic -->
                                            <div dir="rtl">
                                                <div class="form-group row arabicTitle"><div class="col-sm-6" dir="rtl"><label for="">عنوان</label><input type="text" name="ar_title" class="form-control" value="{{ $video->ar_title ?? old('ar_title') ?? '' }}" placeholder="أدخل العنوان"></div></div>
                                                <div class="form-group row arabicDescription"><div class="col-sm-12" dir="rtl"><label for="">وصف</label><textarea name="ar_description" class="form-control">{{ $video->ar_description ?? old('ar_description') ?? '' }}</textarea></div></div>
                                            </div>
                                            <!-- // for arabic -->
                                            <div class="mt-3">
